...
BLOG_AUTHOR = "Sebastian Schmidt"  # (translatable)
BLOG_TITLE = "actin.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://actin.io/"
...
#  placeholder="Search&hellip;" class="span" style="margin-top: 4px;width:100px;"/>
